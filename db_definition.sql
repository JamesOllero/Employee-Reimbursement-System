...
create table project_1.ers_reimbursement_status (reimb_status_id integer primary key not null, reimb_status varchar(10) not null);
create table project_1.ers_reimbursement_type (reimb_type_id integer primary key not null, reimb_type varchar(10) not null);
create table project_1.ers_user_roles (ers_user_role_id integer primary key not null, user_role varchar(10) not null);
create table project_1.ers_user_status (user_status_id integer primary key not null, user_status varchar(10) not null);
commit;

create table project_1.ers_users (ers_users_id serial primary key not null,
...
foreign key (user_role_id) references project_1.ers_user_roles(ers_user_role_id),
foreign key (user_status_id) references project_1.ers_user_status(user_status_id));
commit;
...
insert into project_1.ers_reimbursement_status (reimb_status_id, reimb_status) values (0, 'Pending'), (1, 'Approved'), (2, 'Denied');
insert into project_1.ers_reimbursement_type (reimb_type_id, reimb_type) values (0, 'Lodging'), (1, 'Travel'), (2, 'Food'), (3, 'Other');
insert into project_1.ers_user_roles (ers_user_role_id, user_role) values (0, 'Employee'), (1, 'Manager');
insert into project_1.ers_user_status (user_status_id, user_status) values (0, 'Active'), (1, 'Inactive');
commit;
...
drop table project_1.ers_users;
commit;

drop table project_1.ers_user_roles;
drop table project_1.ers_reimbursement_type;
drop table project_1.ers_reimbursement_status;
commit;